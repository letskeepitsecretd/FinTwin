...
async def send_to_n8n(payload: dict) -> bool:
    """Helper to send an email payload to the n8n/Pipedream webhook."""
    import httpx
...
<div style="max-width:600px;margin:0 auto;background:#FFFFFF;border:1px solid #E0E0E0;border-radius:10px;overflow:hidden">
  ...
  <div style="background:#F4F7FC;padding:16px 28px;border-top:1px solid #E0E0E0">
    <p style="margin:0;font-size:11px;color:#8C9AB5;line-height:1.6">This message was generated by <strong>FinTwin</strong> — SBI's AI-powered proactive engagement system.</p>
    ...
    payload["email_body"] = html_body

    try:
        async with httpx.AsyncClient(timeout=15) as client:
            print(f"[n8n payload]: sending to {N8N_WEBHOOK_URL}")
